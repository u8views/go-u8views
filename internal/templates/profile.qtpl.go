                ...
                <div class="profile__select">
                    <div class="sorting__item">
                        <button class="sorting__select sorting-select-js">
                            ...
                            <img class="sorting__icon" src="/assets/images/arrow-down.svg" alt="arrow-down">
                        </button>
		...
		qw422016.N().S(`)
            ...
            <div class="badge__copy">
                <button class="badge__copy-button button-copy-code-js">
                    <img class="badge__copy-icon" src="/assets/images/copy.svg" alt="copy">
                    <span>Copy</span>
                </button>
...
`)
	...
	qw422016.N().S(`
<!--<script src="/assets/js/u8views_2a3df2711b2de3d1342dd49415ddd24f.js"></script>-->
<script src="/assets/js/github-profile-app.js"></script>
</body>
</html>
`)
}
