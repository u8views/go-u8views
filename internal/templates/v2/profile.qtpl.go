...
//line internal/templates/v2/profile.qtpl:1
package v2
...
//line internal/templates/v2/profile.qtpl:6
    ...
    `)
//line internal/templates/v2/profile.qtpl:11
...
//line internal/templates/v2/profile.qtpl:22
	qw422016.E().S(currentPageProfile.SocialProviderUserID)
//line internal/templates/v2/profile.qtpl:22
	qw422016.N().S(`"
        data-session-profile-username="`)
//line internal/templates/v2/profile.qtpl:23
	qw422016.E().S(sessionProfile.Username)
//line internal/templates/v2/profile.qtpl:23
	qw422016.N().S(`"
>
`)
//line internal/templates/v2/profile.qtpl:25
...
<main class="main">
    <div class="wrapper-u8">
        `)
//line internal/templates/v2/profile.qtpl:28
	if showCharity {
//line internal/templates/v2/profile.qtpl:28
		qw422016.N().S(`
        <div class="hero__donate-block profile">
            `)
//line internal/templates/v2/profile.qtpl:30
		streamcharity(qw422016)
//line internal/templates/v2/profile.qtpl:30
		qw422016.N().S(`
        </div>
        `)
//line internal/templates/v2/profile.qtpl:32
	}
//line internal/templates/v2/profile.qtpl:32
	qw422016.N().S(`
...
//line internal/templates/v2/profile.qtpl:38
	qw422016.E().S(currentPageProfile.SocialProviderUserID)
//line internal/templates/v2/profile.qtpl:38
	qw422016.N().S(`?v=4&s=192"
                        alt="`)
//line internal/templates/v2/profile.qtpl:39
	qw422016.E().S(currentPageProfile.GetName())
//line internal/templates/v2/profile.qtpl:39
...
//line internal/templates/v2/profile.qtpl:42
	qw422016.E().S(currentPageProfile.GetName())
//line internal/templates/v2/profile.qtpl:42
	qw422016.N().S(`</span>
                    <a href="https://u8views.com/github/`)
//line internal/templates/v2/profile.qtpl:43
	qw422016.E().S(currentPageProfile.Username)
//line internal/templates/v2/profile.qtpl:43
	qw422016.N().S(`" class="profile__link">
                        <img
                                ...
                                alt="u8views icon"
                        />
                        <span class="profile__u8views-link">u8views.com/github/`)
//line internal/templates/v2/profile.qtpl:50
	qw422016.E().S(currentPageProfile.Username)
//line internal/templates/v2/profile.qtpl:50
	qw422016.N().S(`</span>
                    </a>
                    <a href="https://github.com/`)
//line internal/templates/v2/profile.qtpl:52
	qw422016.E().S(currentPageProfile.Username)
//line internal/templates/v2/profile.qtpl:52
	qw422016.N().S(`" class="profile__link">
                        <img
                                ...
                                alt="GitHub icon"
                        />
                        <span class="profile__github-link">github.com/`)
//line internal/templates/v2/profile.qtpl:59
	qw422016.E().S(currentPageProfile.Username)
//line internal/templates/v2/profile.qtpl:59
	qw422016.N().S(`</span>
                    </a>
...
//line internal/templates/v2/profile.qtpl:65
...
//line internal/templates/v2/profile.qtpl:65
	qw422016.N().S(`</span>
                    ...
                    <div class="history__badge">
                        ...
                        <span class="history__badge-count">`)
//line internal/templates/v2/profile.qtpl:69
...
//line internal/templates/v2/profile.qtpl:69
	qw422016.N().S(`</span>
                    ...
                    <div class="history__badge">
                        ...
                        <span class="history__badge-count">`)
//line internal/templates/v2/profile.qtpl:73
...
//line internal/templates/v2/profile.qtpl:73
	qw422016.N().S(`</span>
                    ...
                    <div class="history__badge">
                        ...
                        <span class="history__badge-count">`)
//line internal/templates/v2/profile.qtpl:77
...
//line internal/templates/v2/profile.qtpl:77
	qw422016.N().S(`</span>
        ...
        `)
//line internal/templates/v2/profile.qtpl:83
...
//line internal/templates/v2/profile.qtpl:83
        ...
        `)
//line internal/templates/v2/profile.qtpl:93
                        ...
                        <div class="step-3__item">
                            ...
                            <div class="step-3__item-content">
                                <p class="step-3__item-text js-code-for-copy">
                                    [![`)
//line internal/templates/v2/profile.qtpl:106
			...
			qw422016.N().S(`)
                        ...
                        <div class="step-3__item">
                            ...
                            <div class="step-3__item-content">
                                <p class="step-3__item-text js-code-for-copy">
                                    &lt;a href=&quot;https://u8views.com/github/`)
//line internal/templates/v2/profile.qtpl:130
			qw422016.E().S(sessionProfile.Username)
//line internal/templates/v2/profile.qtpl:130
...
//line internal/templates/v2/profile.qtpl:130
        ...
        `)
//line internal/templates/v2/profile.qtpl:154
		}
//line internal/templates/v2/profile.qtpl:154
		qw422016.N().S(`
        ...
        `)
//line internal/templates/v2/profile.qtpl:168
	}
//line internal/templates/v2/profile.qtpl:168
	qw422016.N().S(`

        `)
//line internal/templates/v2/profile.qtpl:170
...
//line internal/templates/v2/profile.qtpl:179
...
//line internal/templates/v2/profile.qtpl:179
        ...
        `)
//line internal/templates/v2/profile.qtpl:191
	}
//line internal/templates/v2/profile.qtpl:191
	qw422016.N().S(`

        `)
//line internal/templates/v2/profile.qtpl:193
...
`)
//line internal/templates/v2/profile.qtpl:196
	streamfooter(qw422016)
//line internal/templates/v2/profile.qtpl:196
	qw422016.N().S(`
<script src="/assets/js/github-profile-app.js?`)
//line internal/templates/v2/profile.qtpl:197
...
`)
//line internal/templates/v2/profile.qtpl:200
}
