...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.profileTimePeriodViewsStmt, err = db.PrepareContext(ctx, profileTimePeriodViews); err != nil {
		return nil, fmt.Errorf("error preparing query ProfileTimePeriodViews: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.profileTimePeriodViewsStmt != nil {
		if cerr := q.profileTimePeriodViewsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing profileTimePeriodViewsStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	profileTimePeriodViewsStmt           *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		profileTimePeriodViewsStmt:           q.profileTimePeriodViewsStmt,
