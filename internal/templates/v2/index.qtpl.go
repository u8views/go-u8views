...
//line internal/templates/v2/index.qtpl:1
package v2
...
<head>
    ...
    `)
//line internal/templates/v2/index.qtpl:11
...
//line internal/templates/v2/index.qtpl:22
	qw422016.E().S(sessionProfile.Username)
//line internal/templates/v2/index.qtpl:22
	qw422016.N().S(`"
>
`)
//line internal/templates/v2/index.qtpl:24
...
<main class="main">
    <div class="wrapper-u8">
        <section class="hero">
            `)
//line internal/templates/v2/index.qtpl:28
	if showCharity {
//line internal/templates/v2/index.qtpl:28
		qw422016.N().S(`
            <div class="hero__donate-block">
                `)
//line internal/templates/v2/index.qtpl:30
		streamcharity(qw422016)
//line internal/templates/v2/index.qtpl:30
		qw422016.N().S(`
            </div>
            `)
//line internal/templates/v2/index.qtpl:32
	}
//line internal/templates/v2/index.qtpl:32
	qw422016.N().S(`
            <div class="hero__main">
                ...
                <button class="button__log-in hero-button">
                    `)
//line internal/templates/v2/index.qtpl:39
...
//line internal/templates/v2/index.qtpl:39
		qw422016.N().S(`
                    ...
                    `)
//line internal/templates/v2/index.qtpl:50
	} else {
//line internal/templates/v2/index.qtpl:50
		qw422016.N().S(`
                    <a href="https://u8views.com/github/`)
//line internal/templates/v2/index.qtpl:51
		qw422016.E().S(sessionProfile.Username)
//line internal/templates/v2/index.qtpl:51
		qw422016.N().S(`" class="button__link">
                        <img
                                src="https://avatars.githubusercontent.com/u/`)
//line internal/templates/v2/index.qtpl:53
...
//line internal/templates/v2/index.qtpl:53
		qw422016.N().S(`?v=4&s=48"
                                ...
                                height="24"
                                alt="`)
//line internal/templates/v2/index.qtpl:56
...
//line internal/templates/v2/index.qtpl:56
		qw422016.N().S(` profile photo"
                    ...
                    `)
//line internal/templates/v2/index.qtpl:61
	}
//line internal/templates/v2/index.qtpl:61
	qw422016.N().S(`
                </button>
        ...
        `)
//line internal/templates/v2/index.qtpl:99
        ...
        <section class="history">
            ...
            <div class="history__main">
                ...
                <ul class="history__list">
                    `)
//line internal/templates/v2/index.qtpl:113
		...
		qw422016.N().S(`
                    <li class="history__card">
                        <div class="history__user">
                            <img
                                    src="https://avatars.githubusercontent.com/u/`)
//line internal/templates/v2/index.qtpl:117
		qw422016.E().S(profile.SocialProviderUserID)
//line internal/templates/v2/index.qtpl:117
		qw422016.N().S(`?v=4&s=56"
                                    alt="`)
//line internal/templates/v2/index.qtpl:118
		...
		qw422016.N().S(` profile photo"
                            ...
                            <div class="history__user-info">
                                <div class="history__user-name">
                                    `)
//line internal/templates/v2/index.qtpl:123
		qw422016.E().S(profile.GetName())
//line internal/templates/v2/index.qtpl:123
		qw422016.N().S(`
                                </div>
                                <a href="https://u8views.com/github/`)
//line internal/templates/v2/index.qtpl:125
...
//line internal/templates/v2/index.qtpl:132
		qw422016.E().S(profile.Username)
//line internal/templates/v2/index.qtpl:132
		qw422016.N().S(`</span>
                                </a>
                                <a href="https://github.com/`)
//line internal/templates/v2/index.qtpl:134
		qw422016.E().S(profile.Username)
//line internal/templates/v2/index.qtpl:134
		qw422016.N().S(`" class="history__link">
                                    <img
...
//line internal/templates/v2/index.qtpl:141
		qw422016.E().S(profile.Username)
//line internal/templates/v2/index.qtpl:141
		qw422016.N().S(`</span>
                                </a>
...
//line internal/templates/v2/index.qtpl:148
...
//line internal/templates/v2/index.qtpl:148
		qw422016.N().S(`</span>
                            ...
                            <div class="history__badge">
                                ...
                                <span class="history__badge-count">`)
//line internal/templates/v2/index.qtpl:152
...
//line internal/templates/v2/index.qtpl:152
		qw422016.N().S(`</span>
                            ...
                            <div class="history__badge">
                                ...
                                <span class="history__badge-count">`)
//line internal/templates/v2/index.qtpl:156
...
//line internal/templates/v2/index.qtpl:159
		qw422016.E().S(profile.CreatedAt.Format("15:04, Jan _2 2006"))
//line internal/templates/v2/index.qtpl:159
		qw422016.N().S(`</div>
                    </li>
                    `)
//line internal/templates/v2/index.qtpl:161
	}
//line internal/templates/v2/index.qtpl:161
	qw422016.N().S(`
                </ul>
...
`)
//line internal/templates/v2/index.qtpl:167
	streamfooter(qw422016)
//line internal/templates/v2/index.qtpl:167
	qw422016.N().S(`
<script src="/assets/js/index-app.js?`)
//line internal/templates/v2/index.qtpl:168
...
`)
//line internal/templates/v2/index.qtpl:171
}
